...
export function gatorIntakeForms(env: {
  ...
  return [
    ...
    // SSA-827 is NOT onIntake: a commercially e-signed 827 needs SSA's attestation step before
    // acceptance (POMS DI 11005.017 §C.6). Send it manually with an attorney-attestation confirmation.
    { code: "SSA-827", label: "SSA-827 (Authorization to Disclose Information)", onIntake: false,
